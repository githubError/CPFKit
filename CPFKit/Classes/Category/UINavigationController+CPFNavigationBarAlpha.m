//
//  UINavigationController+CPFNavigationBarAlpha.m
//  CPFKit_Example
//
...
@implementation UIViewController (CPFNavigationBarAlpha)
...
- (void)setNavBarBgAlpha:(NSString *)navBarBgAlpha {
    ...
    CGFloat alpha = [navBarBgAlpha floatValue];
    if (alpha != 1.0) {
...
@implementation UINavigationController (CPFNavigationBarAlpha)
