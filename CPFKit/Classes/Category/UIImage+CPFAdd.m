...
#ifndef CPF_SWAP // swap two value
#define CPF_SWAP(_a_, _b_)  do { __typeof__(_a_) _tmp_ = (_a_); (_a_) = (_b_); (_b_) = _tmp_; } while (0)
#endif

@implementation UIImage (CPFAdd)

CGRect CPFCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = CPFCGRectFitWithContentMode(rect, self.size, contentMode);
